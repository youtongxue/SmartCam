...
public class PlayActivity extends Activity implements View.OnClickListener, WindowSizeChangeNotifier.OnWindowSizeChangedListener, EZUIPlayer.EZUIPlayerCallBack {
    ...
    public static final String APPKEY = "b5ad3b35cb054865a96e58046bc00716";
    public static final String AccessToekn = "at.4s8zgao76k18874i6k8ftjrr67nzwfzh-3utl2tkv0o-09dz8t9-vnb5asmv8";
    public static final String PLAY_URL = "ezopen://open.ys7.com/172124816/1.hd.live";
     ...
     *  授权accesstoken
     */
    private String accesstoken = "at.4s8zgao76k18874i6k8ftjrr67nzwfzh-3utl2tkv0o-09dz8t9-vnb5asmv8";
    /**
     *  播放url：ezopen协议
     */
...
//        mGlobalAreaDomain = intent.getStringExtra(Global_AreanDomain);
    ...
    private View initProgressBar() {
        ...
        mProgressBar.setIndeterminateDrawable(getResources().getDrawable(R.drawable.abc_vector_test));
